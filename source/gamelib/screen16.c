...
void putscreenx8p16_water(s_screen * dest, s_screen * src, int x, int y, int key, unsigned short *remap,
			  unsigned short (*blendfp) (unsigned short, unsigned short), int amplitude, float wavelength,
			  int time, int watermode) {
...
//with remap, work only under 8bit pixel format
void putscreenx8p16(s_screen * dest, s_screen * src, int x, int y, int key, unsigned short *remap,
