...
void putscreenx8p16_water(s_screen * dest, s_screen * src, int x, int y, int key, u16 * remap, u16(*blendfp) (u16, u16),
			  int amplitude, float wavelength, int time, int watermode);
...
void putscreenx8p24(s_screen * dest, s_screen * src, int x, int y, int key, unsigned char *remap,
		    u32(*blendfp) (u32, u32));
...
void putscreenx8p32_water(s_screen * dest, s_screen * src, int x, int y, int key, u32 * remap, u32(*blendfp) (u32, u32),
			  int amplitude, float wavelength, int time, int watermode);
