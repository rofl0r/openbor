...
// Normal putsprite
void putsprite_8(int x, int y, int is_flip, s_sprite * frame, s_screen * screen, unsigned char *remap,
		 unsigned char *blend);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
// Normal putsprite
void putsprite_x8p16(int x, int y, int is_flip, s_sprite * frame, s_screen * screen, unsigned short *remap,
		     unsigned short (*fp) (unsigned short, unsigned short));
//with speical effects
void putsprite_ex_x8p16(int x, int y, s_sprite * frame, s_screen * screen, s_drawmethod * drawmethod);

// Normal putsprite
void putsprite_x8p24(int x, int y, int is_flip, s_sprite * frame, s_screen * screen, unsigned char *remap,
		     unsigned (*fp) (unsigned, unsigned));
//with speical effects
void putsprite_ex_x8p24(int x, int y, s_sprite * frame, s_screen * screen, s_drawmethod * drawmethod);

// Normal putsprite
void putsprite_x8p32(int x, int y, int is_flip, s_sprite * frame, s_screen * screen, unsigned *remap,
		     unsigned (*fp) (unsigned, unsigned));
//with speical effects
